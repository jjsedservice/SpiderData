(async () => {
  ...
  function getHeaders() {
    return [...document.querySelectorAll("#table thead th")].map((th) =>
      th.innerText.trim(),
    );
  }
  ...
  for (let i = 0; i < MAX_PAGE; i++) {
    ...
    allData.push(...extractCurrentPage());
  ...
  a.download = "wind_data.json";
  document.body.appendChild(a);
  a.click();
  document.body.removeChild(a);

  console.log("已导出 wind_data.json");
})();
